...
namespace SensorReadout.AsusRogPlugIn
{
    public sealed class AsusRogPlugIn : ISensorReadoutPlugin, IFanControllablePlugin
    {
        private readonly PluginInfo info = new PluginInfo
        {
            ...
            Description = "Experimental, opt-in Asus ROG probe. Reads ASUS WMI/ATKACPI fan tachometer and temperature values where available, avoids laptop fan-curve writes on desktop towers, and adds desktop support-readiness notes. Based in part on G-Helper ACPI research."
        };
