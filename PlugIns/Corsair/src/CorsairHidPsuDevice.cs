...
namespace SensorReadout.CorsairPlugIn
{
    ...
    public sealed class CorsairHidPsuDevice
    {
        ...
        // included -- the measured HX1200i reports in=65/out=65, so every annex payload offset k
        ...
        /// verified on product 1c27 only and are not in the annex's command set, so a model
        ...
        ///
        /// The name starts at the ordinary data offset. Measured on an HX1200i, whose
