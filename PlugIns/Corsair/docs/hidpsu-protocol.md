...
> lengths on an HX1200i (PID `0x1C27`): `in=65/out=65`. Allocate report
...
> **Editor's note (2026-08-07, live-measurement addendum):** measured against an
...
> ever been sent to the test PSU, so every measurement above comes from read-style traffic only.
> The assumption in the reimplementation is
