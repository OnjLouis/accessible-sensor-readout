...
$clean = [
    ...
    'availability' => [
        ...
        'hasConnectedDiskTotals' => safe_bool($availability['hasConnectedDiskTotals'] ?? false),
    ...
    'hardwareSummary' => [
        ...
        'connectedDiskTotal' => normalize_size_value(safe_string($hardware['connectedDiskTotal'] ?? '', 40)),
        'connectedDiskUsed' => normalize_size_value(safe_string($hardware['connectedDiskUsed'] ?? '', 40)),
        'connectedDiskFree' => normalize_size_value(safe_string($hardware['connectedDiskFree'] ?? '', 40)),
        'connectedDiskCount' => safe_int($hardware['connectedDiskCount'] ?? 0, 0, 1000),
    ...
    'accessibility' => [
        ...
        'highContrastEnabled' => safe_bool($accessibility['highContrastEnabled'] ?? false),
        'stickyKeysEnabled' => safe_bool($accessibility['stickyKeysEnabled'] ?? false),
        'toggleKeysEnabled' => safe_bool($accessibility['toggleKeysEnabled'] ?? false),
        'filterKeysEnabled' => safe_bool($accessibility['filterKeysEnabled'] ?? false),
        'showSoundsEnabled' => safe_bool($accessibility['showSoundsEnabled'] ?? false),
        'audioDescriptionsEnabled' => safe_bool($accessibility['audioDescriptionsEnabled'] ?? false),
