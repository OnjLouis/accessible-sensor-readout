...
5. Start `portable\AccessibleSensorReadout.exe`.
...
- `portable\AccessibleSensorReadout.exe`
...
The `portable` folder includes the runtime DLLs used by the current build. The source is provided separately for review and future development.
