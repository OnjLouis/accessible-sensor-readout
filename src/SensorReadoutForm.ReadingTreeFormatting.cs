...
public sealed partial class SensorReadoutForm : Form
{
    ...
    public static int ReadingSortIndex(string name)
    {
        ...
        if (clean.Equals("Wi-Fi connected", StringComparison.OrdinalIgnoreCase)) return 36;
        ...
        if (clean.Equals("Wi-Fi channel width", StringComparison.OrdinalIgnoreCase)) return 44;
        if (clean.Equals("Wi-Fi frequency", StringComparison.OrdinalIgnoreCase)) return 45;
        if (clean.Equals("Wi-Fi radio type", StringComparison.OrdinalIgnoreCase)) return 46;
        if (clean.Equals("Wi-Fi connection type", StringComparison.OrdinalIgnoreCase)) return 47;
        if (clean.Equals("Wi-Fi receive link speed", StringComparison.OrdinalIgnoreCase)) return 48;
        if (clean.Equals("Wi-Fi transmit link speed", StringComparison.OrdinalIgnoreCase)) return 49;
        if (clean.Equals("Wi-Fi security", StringComparison.OrdinalIgnoreCase)) return 50;
        if (clean.Equals("Wi-Fi authentication", StringComparison.OrdinalIgnoreCase)) return 51;
        if (clean.Equals("Wi-Fi cipher", StringComparison.OrdinalIgnoreCase)) return 52;
